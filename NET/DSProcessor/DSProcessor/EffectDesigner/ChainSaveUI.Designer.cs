namespace DSProcessor.EffectDesigner
{
  partial class ChainSaveUI
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.lvChainView.ItemSelectionChanged += new System.Windows.Forms.ListViewItemSelectionChangedEventHandler(this.lvChainView_ItemSelectionChanged);
      // 
      // lblFilename
      // 
