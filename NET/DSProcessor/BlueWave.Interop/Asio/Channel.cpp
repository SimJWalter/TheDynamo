	...
	namespace Interop
	{
		namespace Asio
		{
			...
			void Channel::default::set(int sample, float value)
			{
				...
				else if (value < __minSampleValue)
				{
					value = __minSampleValue;
				}
			...
			float Channel::MaxSampleValue::get()
			{
				return __maxSampleValue;
			}

			float Channel::MinSampleValue::get()
			{
				return __minSampleValue;
			}
